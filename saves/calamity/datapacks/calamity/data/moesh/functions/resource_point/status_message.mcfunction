# Called from: moesh:resource_point/pressure_plate/trigger
...
execute at @s[tag=Charging,scores={displaySecond=2..}] run title @a[distance=..4] actionbar {"translate":"resourcePoint.statusMessage.chargeSeconds","color":"green","with":[{"score":{"name":"@s","objective":"displaySecond"},"color":"white"}]}
# One second left
execute at @s[tag=Charging,scores={displaySecond=1}] run title @a[distance=..4] actionbar {"translate":"resourcePoint.statusMessage.chargeSecond","color":"green","with":[{"score":{"name":"@s","objective":"displaySecond"},"color":"white"}]}
