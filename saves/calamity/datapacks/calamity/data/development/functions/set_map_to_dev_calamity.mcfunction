...
setblock 137 1 179 minecraft:structure_block[mode=save]{metadata: "", mirror: "NONE", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "Moesh", rotation: "NONE", posX: 0, mode: "SAVE", posY: 47, sizeX: 5, posZ: 1, integrity: 1.0f, showair: 0b, name: "calamity:calamity/mirror_iron_mine2", sizeY: 25, sizeZ: 17, showboundingbox: 1b}
...
setblock 135 1 179 minecraft:structure_block[mode=load]{metadata: "", mirror: "LEFT_RIGHT", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "Moesh", rotation: "CLOCKWISE_180", posX: 0, mode: "LOAD", posY: 47, sizeX: 6, posZ: 1, integrity: 1.0f, showair: 0b, name: "calamity:calamity/mirror_iron_mine2", sizeY: 25, sizeZ: 17, showboundingbox: 1b}
