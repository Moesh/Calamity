# Resource points
execute at @e[type=area_effect_cloud,name=ResourcePoint,tag=FacingEast] run setblock ^ ^ ^3 minecraft:sign[rotation=4]
execute at @e[type=area_effect_cloud,name=ResourcePoint,tag=FacingWest] run setblock ^ ^ ^3 minecraft:sign[rotation=12]
...
# Major points
execute at @e[type=area_effect_cloud,tag=FacingNorth] run setblock ^ ^ ^6 minecraft:sign[rotation=0]
