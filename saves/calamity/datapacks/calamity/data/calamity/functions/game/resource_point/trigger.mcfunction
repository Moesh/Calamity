...
execute @e[type=area_effect_cloud,name=ResourcePoint,tag=ResetPoint] ~ ~ ~ execute @s[tag=TeamBlue] ~ ~ ~ playsound minecraft:block.piston.contract block @a[team=blue] ~ ~-1 ~ 1 1.5
execute @e[type=area_effect_cloud,name=ResourcePoint,tag=ResetPoint] ~ ~ ~ execute @s[tag=TeamRed] ~ ~ ~ playsound minecraft:block.piston.contract block @a[team=red] ~ ~-1 ~ 1 1.5
...
execute @e[type=area_effect_cloud,name=ResourcePoint,tag=CheckStatus,score_SuccessCount_min=1] ~ ~ ~ execute @s[tag=TeamBlue] ~ ~ ~ playsound minecraft:block.piston.extend block @a[team=blue] ~ ~-1 ~ 1 1.5
...
execute @e[type=area_effect_cloud,name=ResourcePoint,tag=CheckStatus,score_SuccessCount_min=1] ~ ~ ~ execute @s[tag=TeamRed] ~ ~ ~ playsound minecraft:block.piston.extend block @a[team=red] ~ ~-1 ~ 1 1.5
