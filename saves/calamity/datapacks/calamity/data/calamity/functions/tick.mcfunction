...
execute if score #tableCandle gameVariable matches 0 run particle minecraft:flame 136.125 58.65 71.86 0 0 0 0 1 normal
...
execute if score #tableCandleSmoke gameVariable matches 0 run particle minecraft:smoke 136.125 58.65 71.86 0 0.1 0 0 1 normal
