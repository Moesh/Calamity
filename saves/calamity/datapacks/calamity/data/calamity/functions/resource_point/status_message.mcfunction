...
execute at @s[tag=!Resetting,scores={displaySecond=2..}] as @a[distance=..4] if block ~ ~-2 ~ minecraft:bedrock run tag @s add GiveMessage
execute at @s[tag=!Resetting,scores={displaySecond=2..}] as @a[distance=..4] if block ~ ~-2 ~ minecraft:bedrock run tag @s add GiveMessage
...
# One second message
execute at @s[tag=!Resetting,scores={displaySecond=1}] as @a[distance=..4] if block ~ ~-2 ~ minecraft:bedrock run tag @s add GiveMessage
execute at @s[tag=!Resetting,scores={displaySecond=1}] as @a[distance=..4] if block ~ ~-2 ~ minecraft:bedrock run tag @s add GiveMessage
