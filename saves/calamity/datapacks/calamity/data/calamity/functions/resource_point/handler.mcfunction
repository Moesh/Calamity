...
execute as @e[type=area_effect_cloud,name=ResourcePoint,tag=Charging] at @s run function calamity:resource_point/update_lights_running 
...
execute as @e[type=area_effect_cloud,name=ResourcePoint,tag=Charging] at @s run function calamity:resource_point/update_sign
execute as @e[type=area_effect_cloud,name=ResourcePoint,tag=Resetting] at @s run function calamity:resource_point/update_sign
