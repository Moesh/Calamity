...
execute if score #tempVar gameVariable matches ..0 unless score Phase gameVariable matches 2.. run function calamity:points/start_phase_2
# Phase 3
...
execute if score #tempVar gameVariable matches ..0 unless score Phase gameVariable matches 3.. run function calamity:points/start_phase_3
# Phase 4
...
execute if score #tempVar gameVariable matches ..0 unless score Phase gameVariable matches 4.. run function calamity:points/start_phase_4
