...
execute if entity @a[tag=Enchant,tag=!CheckForValidItem,team=blue] if score displaySecond gameVariable matches 0..9 run tellraw @a {"translate":"system.timestamped.message","with":[{"translate":"%s:0%s","hoverEvent":{"action":"show_text","contents":[{"translate":"calamity.hover.sessionID","with":[{"score":{"name":"SessionID","objective":"gameVariable"}}]},"\n",{"translate":"calamity.hover.matchTime","with":[{"score":{"name":"MatchTimeInTicks","objective":"gameVariable"}}]}]},"color":"white","with":[{"score":{"name":"displayMinute", "objective":"gameVariable"} },{"score":{"name":"displaySecond", "objective":"gameVariable"}}]}, {"translate":"calamity.generator.enchantedItem.announced","color":"blue","with":[{"translate":"calamity.enchanted.item","color":"white"},{"translate":"team.blue"},{"translate":"b","color":"blue","font": "calamity:icons"}]}]}
execute if entity @a[tag=Enchant,tag=!CheckForValidItem,team=blue] if score displaySecond gameVariable matches 10.. run tellraw @a {"translate":"system.timestamped.message","with":[{"translate":"%s:%s","hoverEvent":{"action":"show_text","contents":[{"translate":"calamity.hover.sessionID","with":[{"score":{"name":"SessionID","objective":"gameVariable"}}]},"\n",{"translate":"calamity.hover.matchTime","with":[{"score":{"name":"MatchTimeInTicks","objective":"gameVariable"}}]}]},"color":"white","with":[{"score":{"name":"displayMinute", "objective":"gameVariable"} },{"score":{"name":"displaySecond", "objective":"gameVariable"}}]}, {"translate":"calamity.generator.enchantedItem.announced","color":"blue","with":[{"translate":"calamity.enchanted.item","color":"white"},{"translate":"team.blue"},{"translate":"b","color":"blue","font": "calamity:icons"}]}]}
execute if entity @a[tag=Enchant,tag=!CheckForValidItem,team=red] if score displaySecond gameVariable matches 0..9 run tellraw @a {"translate":"system.timestamped.message","with":[{"translate":"%s:0%s","hoverEvent":{"action":"show_text","contents":[{"translate":"calamity.hover.sessionID","with":[{"score":{"name":"SessionID","objective":"gameVariable"}}]},"\n",{"translate":"calamity.hover.matchTime","with":[{"score":{"name":"MatchTimeInTicks","objective":"gameVariable"}}]}]},"color":"white","with":[{"score":{"name":"displayMinute", "objective":"gameVariable"} },{"score":{"name":"displaySecond", "objective":"gameVariable"}}]}, {"translate":"calamity.generator.enchantedItem.announced","color":"red","with":[{"translate":"calamity.enchanted.item","color":"white"},{"translate":"team.red"},{"translate":"r","color":"red","font": "calamity:icons"}]}]}
execute if entity @a[tag=Enchant,tag=!CheckForValidItem,team=red] if score displaySecond gameVariable matches 10.. run tellraw @a {"translate":"system.timestamped.message","with":[{"translate":"%s:%s","hoverEvent":{"action":"show_text","contents":[{"translate":"calamity.hover.sessionID","with":[{"score":{"name":"SessionID","objective":"gameVariable"}}]},"\n",{"translate":"calamity.hover.matchTime","with":[{"score":{"name":"MatchTimeInTicks","objective":"gameVariable"}}]}]},"color":"white","with":[{"score":{"name":"displayMinute", "objective":"gameVariable"} },{"score":{"name":"displaySecond", "objective":"gameVariable"}}]}, {"translate":"calamity.generator.enchantedItem.announced","color":"red","with":[{"translate":"calamity.enchanted.item","color":"white"},{"translate":"team.red"},{"translate":"r","color":"red","font": "calamity:icons"}]}]}
...
execute if entity @a[tag=Enchant,tag=CheckForValidItem,team=blue] if score displaySecond gameVariable matches 0..9 run tellraw @a {"translate":"system.timestamped.message","with":[{"translate":"%s:0%s","hoverEvent":{"action":"show_text","contents":[{"translate":"calamity.hover.sessionID","with":[{"score":{"name":"SessionID","objective":"gameVariable"}}]},"\n",{"translate":"calamity.hover.matchTime","with":[{"score":{"name":"MatchTimeInTicks","objective":"gameVariable"}}]}]},"color":"white","with":[{"score":{"name":"displayMinute", "objective":"gameVariable"} },{"score":{"name":"displaySecond", "objective":"gameVariable"}}]}, {"translate":"calamity.generator.enchantedItem.announced.invalid","color":"blue","with":[{"translate":"team.blue"},{"translate":"b","color":"blue","font": "calamity:icons"}]}]}
execute if entity @a[tag=Enchant,tag=CheckForValidItem,team=blue] if score displaySecond gameVariable matches 10.. run tellraw @a {"translate":"system.timestamped.message","with":[{"translate":"%s:%s","hoverEvent":{"action":"show_text","contents":[{"translate":"calamity.hover.sessionID","with":[{"score":{"name":"SessionID","objective":"gameVariable"}}]},"\n",{"translate":"calamity.hover.matchTime","with":[{"score":{"name":"MatchTimeInTicks","objective":"gameVariable"}}]}]},"color":"white","with":[{"score":{"name":"displayMinute", "objective":"gameVariable"} },{"score":{"name":"displaySecond", "objective":"gameVariable"}}]}, {"translate":"calamity.generator.enchantedItem.announced.invalid","color":"blue","with":[{"translate":"team.blue"},{"translate":"b","color":"blue","font": "calamity:icons"}]}]}
execute if entity @a[tag=Enchant,tag=CheckForValidItem,team=red] if score displaySecond gameVariable matches 0..9 run tellraw @a {"translate":"system.timestamped.message","with":[{"translate":"%s:0%s","hoverEvent":{"action":"show_text","contents":[{"translate":"calamity.hover.sessionID","with":[{"score":{"name":"SessionID","objective":"gameVariable"}}]},"\n",{"translate":"calamity.hover.matchTime","with":[{"score":{"name":"MatchTimeInTicks","objective":"gameVariable"}}]}]},"color":"white","with":[{"score":{"name":"displayMinute", "objective":"gameVariable"} },{"score":{"name":"displaySecond", "objective":"gameVariable"}}]}, {"translate":"calamity.generator.enchantedItem.announced.invalid","color":"red","with":[{"translate":"team.red"},{"translate":"r","color": "red","font": "calamity:icons"}]}]}
execute if entity @a[tag=Enchant,tag=CheckForValidItem,team=red] if score displaySecond gameVariable matches 10.. run tellraw @a {"translate":"system.timestamped.message","with":[{"translate":"%s:%s","hoverEvent":{"action":"show_text","contents":[{"translate":"calamity.hover.sessionID","with":[{"score":{"name":"SessionID","objective":"gameVariable"}}]},"\n",{"translate":"calamity.hover.matchTime","with":[{"score":{"name":"MatchTimeInTicks","objective":"gameVariable"}}]}]},"color":"white","with":[{"score":{"name":"displayMinute", "objective":"gameVariable"} },{"score":{"name":"displaySecond", "objective":"gameVariable"}}]}, {"translate":"calamity.generator.enchantedItem.announced.invalid","color":"red","with":[{"translate":"team.red"},{"translate":"r","color": "red","font": "calamity:icons"}]}]}
