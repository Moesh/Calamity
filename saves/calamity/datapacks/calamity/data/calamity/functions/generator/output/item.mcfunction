...
execute as @s[tag=ArrowOfSlowFalling] run title @a[distance=..4,tag=GiveItem] actionbar {"translate":"calamity.generator.output.item","with":[{"translate":"item.minecraft.tipped_arrow.effect.slow_falling"},{"text":"16"}]}
...
execute as @s[tag=LingeringPotionOfLevitation] run title @a[distance=..4,tag=GiveItem] actionbar {"translate":"calamity.generator.output.item","with":[{"translate":"item.minecraft.potion.effect.slow_falling"},{"text":"1"}]}
