...
execute if entity @a[team=blue,tag=ForfeitTriggered,tag=VotedForfeit] if score #tempPlayerCount gameVariable > #tempForfeitCount gameVariable run tellraw @a[team=blue] {"translate":"system.message","color": "green","with":[{"translate":"calamity.forfeit.started","color": "green","with":[{"selector":"@s"},{"score":{"name": "#tempForfeitCount","objective": "gameVariable"}},{"score":{"name": "#tempPlayerCount","objective": "gameVariable"}},{"text":"/trigger gg","color":"green","clickEvent":{"action":"suggest_command","value":"/trigger gg"},"hoverEvent":{"action":"show_text","value":{"translate":"calamity.hover.sendTriggerCommand"}}}]}]}
...
# Tell players on the team someone wants to forfeit
execute if entity @a[team=red,tag=ForfeitTriggered,tag=VotedForfeit] if score #tempPlayerCount gameVariable > #tempForfeitCount gameVariable run tellraw @a[team=red] {"translate":"system.message","color": "green","with":[{"translate":"calamity.forfeit.started","with":[{"selector":"@s"},{"score":{"name": "#tempForfeitCount","objective": "gameVariable"}},{"score":{"name": "#tempPlayerCount","objective": "gameVariable"}},{"text":"/trigger gg","color":"green","clickEvent":{"action":"suggest_command","value":"/trigger gg"},"hoverEvent":{"action":"show_text","value":{"translate":"calamity.hover.sendTriggerCommand"}}}]}]}
