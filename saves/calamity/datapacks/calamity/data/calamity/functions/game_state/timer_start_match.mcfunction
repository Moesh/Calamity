...
#>--------------------------------------------------------------------------------------------------
#> Purpose: Tick down the variable TimeInTicks to 0 and then start the match.
#>--------------------------------------------------------------------------------------------------
...
# Ticking down the timer at the end of the file ensures commands are not skipped
