...
execute positioned ~1 ~ ~ if block ~ ~ ~ structure_void run function calamity:build_protection/setup_wall
execute positioned ~-1 ~ ~ if block ~ ~ ~ structure_void run function calamity:build_protection/setup_wall
execute positioned ~ ~ ~1 if block ~ ~ ~ structure_void run function calamity:build_protection/setup_wall
execute positioned ~ ~ ~-1 if block ~ ~ ~ structure_void run function calamity:build_protection/setup_wall
execute positioned ~1 ~ ~-1 if block ~ ~ ~ structure_void run function calamity:build_protection/setup_wall
execute positioned ~1 ~ ~1 if block ~ ~ ~ structure_void run function calamity:build_protection/setup_wall
execute positioned ~-1 ~ ~-1 if block ~ ~ ~ structure_void run function calamity:build_protection/setup_wall
execute positioned ~-1 ~ ~1 if block ~ ~ ~ structure_void run function calamity:build_protection/setup_wall
