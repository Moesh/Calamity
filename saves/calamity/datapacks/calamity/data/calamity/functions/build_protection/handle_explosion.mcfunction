...
execute store result score #tempVar gameVariable run clone ~-12 69 ~-12 ~-1 69 ~-1 ~-12 69 ~-12 filtered #calamity:void_protection_block force
execute if score #tempVar gameVariable matches 1.. positioned ~-6 ~ ~-6 run function calamity:build_protection/section_medium

execute store result score #tempVar gameVariable run clone ~-12 69 ~0 ~-1 69 ~11 ~-12 69 ~0 filtered #calamity:void_protection_block force
execute if score #tempVar gameVariable matches 1.. positioned ~-6 ~ ~6 run function calamity:build_protection/section_medium

execute store result score #tempVar gameVariable run clone ~0 69 ~-12 ~11 69 ~-1 ~0 69 ~-12 filtered #calamity:void_protection_block force
execute if score #tempVar gameVariable matches 1.. positioned ~6 ~ ~-6 run function calamity:build_protection/section_medium

execute store result score #tempVar gameVariable run clone ~0 69 ~0 ~11 69 ~11 ~0 69 ~0 filtered #calamity:void_protection_block force
execute if score #tempVar gameVariable matches 1.. positioned ~6 ~ ~6 run function calamity:build_protection/section_medium
