...
# Torch flame
execute if score #tableCandle gameVariable matches 0 run particle minecraft:flame 138.125 18.65 118.86 0 0 0 0 1 normal
...
# Torch smoke!
execute if score #tableCandleSmoke gameVariable matches 0 run particle minecraft:smoke 138.125 18.65 118.86 0 0.1 0 0 1 normal
