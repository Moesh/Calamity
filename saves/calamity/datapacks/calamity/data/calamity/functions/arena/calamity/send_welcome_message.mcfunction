...
tellraw @s {"translate":"system.message","color":"green","with":[{"translate":"arena.calamity.welcome","with":[{"translate":"arena.calamity.name","color":"white"},{"translate":"arena.calamity.author","underlined": true,"color": "blue","hoverEvent": {"action": "show_text","value": {"translate":"calamity.hover.moesh.twitter"}},"clickEvent": {"action": "open_url","value": "https://twitter.com/HeartlessMoesh"}}]}]}