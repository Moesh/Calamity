...
#>--------------------------------------------------------------------------------------------------
#> Purpose: Sets the arena back to development mode.
#>--------------------------------------------------------------------------------------------------

# Place structure blocks which reference Shattering's structures
...
setblock 137 0 179 minecraft:structure_block[mode=save]{metadata: "", mirror: "NONE", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "Moesh", rotation: "NONE", posX: 0, mode: "SAVE", posY: 0, sizeX: 5, posZ: 1, integrity: 1.0f, showair: 0b, name: "calamity:shattering/shattering_iron_mine1", sizeY: 48, sizeZ: 17, showboundingbox: 1b}
setblock 137 1 179 minecraft:structure_block[mode=save]{metadata: "", mirror: "NONE", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "Moesh", rotation: "NONE", posX: 0, mode: "SAVE", posY: 47, sizeX: 5, posZ: 1, integrity: 1.0f, showair: 0b, name: "calamity:shattering/shattering_iron_mine2", sizeY: 27, sizeZ: 17, showboundingbox: 1b}
setblock 135 0 179 minecraft:structure_block[mode=load]{metadata: "", mirror: "LEFT_RIGHT", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "Moesh", rotation: "CLOCKWISE_180", posX: 0, mode: "LOAD", posY: 0, sizeX: 6, posZ: 1, integrity: 1.0f, showair: 0b, name: "calamity:shattering/shattering_iron_mine1", sizeY: 48, sizeZ: 17, showboundingbox: 1b}
setblock 135 1 179 minecraft:structure_block[mode=load]{metadata: "", mirror: "LEFT_RIGHT", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "Moesh", rotation: "CLOCKWISE_180", posX: 0, mode: "LOAD", posY: 47, sizeX: 6, posZ: 1, integrity: 1.0f, showair: 0b, name: "calamity:shattering/shattering_iron_mine2", sizeY: 27, sizeZ: 17, showboundingbox: 1b}
...
setblock 117 34 74 minecraft:structure_block[mode=save]{metadata: "", mirror: "NONE", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "?", rotation: "NONE", posX: 0, mode: "SAVE", posY: 1, sizeX: 39, posZ: 0, integrity: 1.0f, showair: 0b, name: "calamity:shattering/lobby2", sizeY: 33, sizeZ: 3, showboundingbox: 1b}
