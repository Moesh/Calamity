...
#   #arenaAction gameVariable 8 = Give spawn items
...
#> 1 - Calamity: Modern by Moesh
    ...
    # 8 Give spawn items
    execute if score #arenaAction gameVariable matches 8 if score #currentArena gameVariable matches 1 run give @s wooden_axe{RepairCost:666,Damage:45,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:4,Operation:0,UUID:[I;-31386206,-663338499,-1677180052,-261106179],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:1,Operation:0,UUID:[I;1174657704,-1982709368,-1633494077,363317273],Slot:"mainhand"}]} 1
...
#> 2 - Shattering by Panguino (edited by Moesh)
    ...
    # 8 Give spawn items
    execute if score #arenaAction gameVariable matches 8 if score #currentArena gameVariable matches 2 as @a run give @s bow{Unbreakable:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:4,Operation:0,UUID:[I;-31386206,-663338499,-1677180052,-261106179],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:1,Operation:0,UUID:[I;1174657704,-1982709368,-1633494077,363317273],Slot:"mainhand"},{AttributeName:"generic.armor",Name:"generic.armor",Amount:12,Operation:0,UUID:[I;-2068228233,-322420677,-1309210629,532578535],Slot:"mainhand"}]} 1
    execute if score #arenaAction gameVariable matches 8 if score #currentArena gameVariable matches 2 as @a run give @s minecraft:arrow 16
