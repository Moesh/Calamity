...
execute at @e[type=minecraft:area_effect_cloud,name="Generator",tag=SpectralArrow] run data merge block ^ ^ ^3 {Text1: "{\"translate\":\"calamity.generator.sign.type\",\"with\":[{\"translate\":\"item.minecraft.spectral_arrow\"}]}", Text4: "{\"translate\":\"calamity.generator.sign.perPlayer\",\"with\":[{\"text\":\"16\"}]}"}
execute at @e[type=minecraft:area_effect_cloud,name="Generator",tag=SplashPotionOfLevitation] run data merge block ^ ^ ^3 {Text1: "{\"translate\":\"calamity.generator.sign.type\",\"with\":[{\"translate\":\"item.minecraft.tipped_arrow.effect.levitation\"}]}", Text2: "{\"translate\":\"item.minecraft.tipped_arrow\"}", Text4: "{\"translate\":\"calamity.generator.sign.perPlayer\",\"with\":[{\"text\":\"1\"}]}"}
# Effects
