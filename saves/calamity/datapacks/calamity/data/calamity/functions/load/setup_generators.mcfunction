...
execute at @e[type=minecraft:area_effect_cloud,name="LobbyPoint",tag=ArrowOfLevitation] run data merge block ^ ^ ^1 {Text1: "{\"translate\":\"calamity.generator.sign.type\",\"with\":[{\"translate\":\"item.minecraft.tipped_arrow.effect.levitation\"}]}", Text2: "{\"translate\":\"item.minecraft.tipped_arrow\"}", Text4: "{\"translate\":\"calamity.generator.sign.perPlayer\",\"with\":[{\"text\":\"16\"}]}"}
execute at @e[type=minecraft:area_effect_cloud,name="LobbyPoint",tag=SpectralArrow] run data merge block ^ ^ ^1 {Text1: "{\"translate\":\"calamity.generator.sign.type\",\"with\":[{\"translate\":\"item.minecraft.spectral_arrow\"}]}", Text4: "{\"translate\":\"calamity.generator.sign.perPlayer\",\"with\":[{\"text\":\"16\"}]}"}
execute at @e[type=minecraft:area_effect_cloud,name="LobbyPoint",tag=SplashPotionOfSlowFalling] run data merge block ^ ^ ^1 {Text1: "{\"translate\":\"calamity.generator.sign.type\",\"with\":[{\"translate\":\"effect.minecraft.slow_falling\"}]}", Text2: "{\"translate\":\"item.minecraft.tipped_arrow\"}", Text4: "{\"translate\":\"calamity.generator.sign.perPlayer\",\"with\":[{\"text\":\"1\"}]}"}
# Effects
