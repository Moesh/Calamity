...
execute @s[tag=UpdateSign] ~ ~ ~ blockdata ~ ~ ~-6 {Text2:"{\"translate\":\"objective.sign.progress\",\"with\":[{\"score\":{\"name\":\"@e[c=1,r=7,type=area_effect_cloud,name=MajorPoint]\",\"objective\":\"displayPercent\"}}]}"}
...
scoreboard players operation @s[score_SuccessCount_min=1,tag=Resetting] displayPercent += 100 CONST
execute @s[score_SuccessCount_min=1,tag=Resetting] ~ ~ ~ scoreboard players tag @s add UpdateSign
execute @s[tag=UpdateSign] ~ ~ ~ blockdata ~ ~ ~-6 {Text2:"{\"translate\":\"objective.sign.resetting\",\"with\":[{\"score\":{\"name\":\"@e[c=1,r=7,type=area_effect_cloud,name=MajorPoint]\",\"objective\":\"displayPercent\"}}]}"}
scoreboard players tag @s[tag=UpdateSign] remove UpdateSign