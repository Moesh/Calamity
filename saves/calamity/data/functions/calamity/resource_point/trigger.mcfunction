...
execute @e[type=area_effect_cloud,name=ResourcePoint,tag=!CheckedStatus,score_SuccessCount_min=1] ~ ~ ~ playsound minecraft:block.piston.contract block @a ~ ~-1 ~ 1 1.5
