...
execute @s[tag=UpdateSign] ~ ~ ~ execute @s[tag=FacingWest] ~ ~ ~ blockdata ~-3 ~ ~ {Text2:"{\"translate\":\"resourcePoint.sign.progress\",\"with\":[{\"score\":{\"name\":\"@e[c=1,r=5,type=area_effect_cloud,name=ResourcePoint]\",\"objective\":\"displayPercent\"}},\"%\"]}"}
execute @s[tag=UpdateSign] ~ ~ ~ execute @s[tag=FacingEast] ~ ~ ~ blockdata ~3 ~ ~ {Text2:"{\"translate\":\"resourcePoint.sign.progress\",\"with\":[{\"score\":{\"name\":\"@e[c=1,r=5,type=area_effect_cloud,name=ResourcePoint]\",\"objective\":\"displayPercent\"}},\"%\"]}"}
...
scoreboard players operation @s[score_SuccessCount_min=1,tag=Resetting] displayPercent += 100 CONST
execute @s[score_SuccessCount_min=1,tag=Resetting] ~ ~ ~ scoreboard players tag @s add UpdateSign
execute @s[tag=UpdateSign] ~ ~ ~ execute @s[tag=FacingWest] ~ ~ ~ blockdata ~-3 ~ ~ {Text2:"{\"translate\":\"resourcePoint.sign.resetting\",\"with\":[{\"score\":{\"name\":\"@e[c=1,r=5,type=area_effect_cloud,name=ResourcePoint]\",\"objective\":\"displayPercent\"}},\"%\"]}"}
execute @s[tag=UpdateSign] ~ ~ ~ execute @s[tag=FacingEast] ~ ~ ~ blockdata ~3 ~ ~ {Text2:"{\"translate\":\"resourcePoint.sign.resetting\",\"with\":[{\"score\":{\"name\":\"@e[c=1,r=5,type=area_effect_cloud,name=ResourcePoint]\",\"objective\":\"displayPercent\"}},\"%\"]}"}
scoreboard players tag @s[tag=UpdateSign] remove UpdateSign