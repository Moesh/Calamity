...
execute @s[score_SuccessCount_min=1] ~ ~ ~ blockdata ~-4 ~ ~ {Text2:"{\"translate\":\"Progress: %s\",\"with\":[{\"score\":{\"name\":\"@e[c=1,r=5,type=area_effect_cloud,name=ResourcePoint]\",\"objective\":\"displaySecond\"}}]}"}